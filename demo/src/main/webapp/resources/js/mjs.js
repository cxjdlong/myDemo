...
function edtfun(checkboxName){
	...
	if(chestr != 1){
	  ...
	  window.location.href = "/masteLo/master/"+selectValue+".html";
	}
}

function addfun(){
	 window.location.href = "/masteLo/master/toAdd.html";
}
...
function delfun(id,checkboxName){
	...
	if(chestr == ""){
	  ...
	  window.location.href = "/masteLo/master/del.html?id="+delKey+"&sortID="+id;
	}
}
