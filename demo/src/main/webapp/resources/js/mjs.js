...
function edtfun(checkboxName){
	...
	if(chestr != 1){
	  ...
	  window.location.href = "/mastLo/master_edt.html?id="+selectValue;
	}
}

function addfun(){
	 window.location.href = "/mastLo/master_add.html";
}
...
//	  alert("您先择的是："+ delKey +"");
	  window.location.href = "/mastLo/master_del.html?id="+id+"&sid="+delKey;
	}
}
