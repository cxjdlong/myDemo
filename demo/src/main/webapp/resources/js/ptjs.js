...
function edtfun(checkboxName){
	...
	if(chestr != 1){
	  ...
	  window.location.href = "/mastLo/pro_tedt.html?id="+selectValue;
	}
}

function addfun(){
	 window.location.href = "/mastLo/pro_tadd.html";
}
...
//	  alert("您先择的是："+ delKey +"");
	  window.location.href = "/mastLo/pro_tdel.html?id="+id+"&sid="+delKey;
	}
}