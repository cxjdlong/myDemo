...
function edtfun(checkboxName){
	...
	if(chestr != 1){
	  ...
	  window.location.href = "/masteLo/newstype/"+selectValue+".html";
	}
}

function addfun(){
	window.location.href = "/masteLo/newstype/toAdd.html";
}
...
//	  alert("您先择的是："+ delKey +"");
	  window.location.href = "/masteLo/newstype/del.html?id="+delKey+"&sortID="+id;
	}
}