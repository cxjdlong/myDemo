...
<body>
   ...
   <form id="myform" method="post" action="/mastLo/anews_taddfun.html" onsubmit="return addmessFun();">
    <ul class="forminfo">
	    <li><label>列表名字</label><input id="className" onblur="caddmessFun('className');" name="newtype.className" type="text" class="dfinput" value="" /><i id="cclassName">* 信息分类 名字</i></li>
	    <li><label>对于URL</label><input id="url" onblur="caddmessFun('url');" name="newtype.url" type="text" class="dfinput" value="" /><i id="curl">* 对于URL:首页使用居多</i></li>	  
