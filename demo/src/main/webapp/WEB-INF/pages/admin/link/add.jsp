...
<body>
   ...
   <form id="myform" method="post" action="/mastLo/website_laddfun.html" onsubmit="return addmessFun();">
    <ul class="forminfo">
	    <li><label>列表名字</label><input id="urlName" onblur="caddmessFun('urlName');" name="clink.urlName" type="text" class="dfinput" value="" /><i id="curlName">* 信息分类 名字</i></li>
	    <li><label>对于URL</label><input id="urlLink" onblur="caddmessFun('urlLink');" name="clink.urlLink" type="text" class="dfinput" value="http://" /><i id="curlLink">* http://开头</i></li>
	    <li><label>排序ID</label><input id="urlOrder" onblur="caddmessFun('urlOrder');" name="clink.urlOrder" type="text" class="dfinput" value="100" /><i id=curlOrder>* 数字越小 越靠前</i></li>	  
