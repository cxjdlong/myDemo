...
<script type="text/javascript">
		...
		if(true){
       		...
       		if (urlLink.length<1 || urlLink.length>200){$('curlLink').innerHTML = '<font color=red>* URL 必须在50个字符之间</font>';	
      		 return false;
...
<body>
   ...
   <sf:form id="myform" method="post" action="/masteLo/link/add.html" modelAttribute="link" onsubmit="return addmessFun();" enctype="multipart/form-data">
    <ul class="forminfo">
	    <li><label>列表名字</label><input id="urlName" onblur="caddmessFun('urlName');" name="urlName" type="text" class="dfinput" value="" /><i id="curlName">* 信息分类 名字</i></li>
	    <li><label>对于URL</label><input id="urlLink" onblur="caddmessFun('urlLink');" name="urlLink" type="text" class="dfinput" value="http://" /><i id="curlLink">* http://开头</i></li>
	    <li><label>排序ID</label><input id="urlOrder" onblur="caddmessFun('urlOrder');" name="urlOrder" type="text" class="dfinput" value="100" /><i id=curlOrder>* 数字越小 越靠前</i></li>	  
