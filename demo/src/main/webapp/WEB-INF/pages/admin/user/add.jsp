...
<body>
   ...
   <form id="myform" name="form1" method="post" action="/mastLo/user_addfun.html" onsubmit="return addmessFun();">
    <ul class="forminfo">
	    <li><label>关键字</label><textarea id="seoKeyword" onblur="caddmessFun('seoKeyword');" name="juser.seoKeyword" cols="" rows="" class="textinput"></textarea><i id="cseoKeyword">* 关键字 必须在 5到500个字符之间</i></li>
	    <li><label>描述</label><textarea id="seoDescription" onblur="caddmessFun('seoDescription');" name="juser.seoDescription" cols="" rows="" class="textinput"></textarea><i id="cseoDescription">描述必须在5到500个字符之间</i></li>	   
	    <li><label>用户名</label><input id="userName" onblur="caddmessFun('userName');" name="juser.userName" type="text" class="dfinput" value="" /><i id="cuserName">* 用户名 ，必须在5到20个字符之间</i></li>
		<li><label>密    码</label><input id="userPass" onblur="caddmessFun('userPass');" name="juser.userPass" type="text" class="dfinput" value="" /><i id="cuserPass">* 登陆密码 ，必须在5到20个字符之间</i></li>
		<li><label>联系电话</label><input id="userTel" onblur="caddmessFun('userTel');" name="juser.userTel" type="text" class="dfinput" value="" /><i id="cuserTel">* 联系电话 ，</i></li>
	    <li><label>联系QQ</label><input id="userqq" onblur="caddmessFun('userqq');" name="juser.userqq" type="text" class="dfinput" value="" /><i id="cuserqq">* 联系QQ，</i></li>
	    <li><label>证件号码</label><input id="uidcard" onblur="caddmessFun('uidcard');" name="juser.uidcard" type="text" class="dfinput" value="" /><i id="cuidcard">* 身份证号码 </i></li>
	    <li><label>证件照</label><input id="uidcarImg" onblur="caddmessFun('uidcarImg');" name="juser.uidcarImg" type="text" readonly class="dfinput" value="" /><input type="button" value=" 图片添加 " name="fckpic1" class="btnpic" onclick="openUpladage('uidcarImg','pic','sfz');" /><i id="cuidcarImg">*身份证正反面</i></li>
	    <li><label>商铺图片</label><input id="usComImg" onblur="caddmessFun('usComImg');" name="juser.usComImg" type="text" readonly class="dfinput" value="" /><input type="button" value=" 图片添加 " name="fckpic1" class="btnpic" onclick="openUpladage('usComImg','pic','dp');" /><i id="cusComImg">* 商铺图片</i></li>
	    <li><label>是否推荐</label>
	    ...
	    <li><label>发布者</label><input id="author" onblur="caddmessFun('author');" name="juser.author" type="text" class="dfinput" value="" /><i id="cauthor">* 请填写编辑者,必须在2到5个字符之间</i></li>
	    <li><label>商铺名字</label><input id="userComname" onblur="caddmessFun('userComname');" name="juser.userComname" type="text" class="dfinput" value="" /><i id="cuserComname">* 商铺授权名字</i></li>
	    <li><label>商铺地址</label><input id="userAddr" onblur="caddmessFun('userAddr');" name="juser.userAddr" type="text" class="dfinput" value="" /><i id="cuserAddr">* 商铺详细地址</i></li>
	    ...
	    <li><label>备相关注</label><textarea id="userNote" onblur="caddmessFun('userNote');" name="juser.userNote" cols="" rows="" class="textinput"></textarea><i id="cuserNote">* 备注</i></li>	    	    
	    <li><label>信息内容</label><p><input type="button" value=" 编辑器图片添加" name="fckpic1" class="btnpic2" onclick="openUpladage('tscompanyContent','','');" /></p>	  
	    <textarea name="juser.userContent" id="tscompanyContent" rows="8" style="display:none"></textarea>
