...
<body>
   ...
   <sf:form id="myform" method="post" action="/masteLo/pros/add.html" modelAttribute="pro" onsubmit="return addmessFun();" enctype="multipart/form-data"> 
    <ul class="forminfo">
	    ...
	    <li><label>seo描述</label><textarea id="seoDescription" onblur="caddmessFun('seoDescription');" name="seoDescription" cols="" rows="" class="textinput"></textarea><i id="cseoDescription">SEO描述必须在5到500个字符之间</i></li>
	    <li><label>产品描述</label><textarea id="proCaption" onblur="caddmessFun('proCaption');" name="proCaption" cols="" rows="" class="textinput"></textarea><i id="cproCaption">产品描述必须在5到500个字符之间</i></li>	   
	    <li><label>标题</label><input id="productName" onblur="caddmessFun('productName');" name="productName" type="text" class="dfinput" value="" /><i id="cproductName">* 信息标题 ，必须在2到20个字符之间</i></li>
	    ...
	    <li><label>信息分类</label>
			...
			<select name="proClassId">
		        ...
		        <option value='${protype.id }'>&nbsp;&nbsp;${ protype.className}&nbsp;&nbsp;</option>
		    	</c:forEach>   
			</select>
		
		</li>
	    <li><label>产品图片</label><input id="proImg" onblur="caddmessFun('proImg');" name="proImg" readonly type="text" class="dfinput" value="4444444" /><input type="button" value=" 图片添加 " name="fckpic1" class="btnpic" onclick="openUpladage('proImg','pic','cp');" /><i id="cproImg">* 请上传产品图片</i></li>
	    ...
	    <textarea name="proContent" id="tscompanyContent" rows="8" style="display:none"></textarea>
