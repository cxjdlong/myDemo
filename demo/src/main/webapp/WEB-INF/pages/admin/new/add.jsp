...
<body>
   ...
   <form id="myform" name="form1" method="post" action="/mastLo/anews_addfun.html" onsubmit="return addmessFun();">
    <ul class="forminfo">
	    ...
	    <li><label>新闻图片</label><input id="newsImg" onblur="caddmessFun('newsImg');" readonly name="cnews.newsImg" type="text" class="dfinput" value="" /><input type="button" value=" 图片添加 " name="fckpic1" class="btnpic" onclick="openUpladage('newsImg','pic','n');" /><i id="cnewsImg">* 请上传新闻图片</i></li>
	    <li><label>发布者</label><input id="author" onblur="caddmessFun('author');" name="cnews.author" type="text" class="dfinput" value="" /><i id="cauthor">* 请填写编辑者,必须在2到5个字符之间</i></li>
	    <li><label>点击次数</label><input id="looknum" onblur="caddmessFun('looknum');" name="cnews.looknum" type="text" class="dfinput" value="1" /><i id="clooknum">* 请输入点击次数 默认1</i></li>
	    <li><label>是否推荐</label>
	    ...
	    <textarea name="cnews.newsContent" id="tscompanyContent" rows="8" style="display:none"></textarea>
